...
export class PlexApiService {
  ...
  public async getStatus() {
    try {
      ...
      this.logger.error('An error occurred getting Plex status', err);
    }
  }
  ...
  public async searchContent(input: string) {
    try {
      ...
      this.logger.error('An error occurred searching Plex', err);
    }
  }
  ...
  public async getUsers(): Promise<PlexUserAccount[]> {
    try {
      ...
      this.logger.error('An error occurred getting users from Plex', err);
    }
  }
  ...
  public async getUser(id: number): Promise<PlexUserAccount> {
    try {
      ...
      this.logger.error('An error occurred getting a user from Plex', err);
    }
  }
  ...
  public async getLibraries(): Promise<PlexLibrary[]> {
    try {
      ...
      this.logger.error('An error occurred getting libraries from Plex', err);
    }
  }
  ...
  public async getLibraryContentCount(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred getting library content count from Plex',
        err,
      );
    }
  }
  ...
  public async getLibraryContents(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred getting library content from Plex',
        err,
      );
    }
  }
  ...
  public async searchLibraryContents(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred searching library content in Plex',
        err,
      );
    }
  }
  ...
  public async getMetadata(
    ...
    try {
      ...
      this.logger.error('An error occurred getting metadata from Plex', err);
    }
  }
  ...
  public async getChildrenMetadata(key: string): Promise<PlexMetadata[]> {
    try {
      ...
      this.logger.error(
        `An error occurred getting children metadata from Plex`,
        err,
      );
    }
  }
  ...
  public async getRecentlyAdded(
    ...
    try {
      ...
      this.logger.error(
        `An error occurred getting recently added from Plex`,
        err,
      );
    }
  }
  ...
  public async getWatchHistory(itemId: string): Promise<PlexSeenBy[]> {
    try {
      ...
      this.logger.error(
        `An error occurred getting watch history from Plex`,
        err,
      );
    }
  }
  ...
  public async getCollections(
    ...
    try {
      ...
      this.logger.error(`An error occurred getting collections from Plex`, err);
    }
  }
  ...
  public async getPlaylists(libraryId: string): Promise<PlexPlaylist[]> {
    try {
      ...
      this.logger.error(`An error occurred getting playlists from Plex`, err);
    }
  }
  ...
  public async createCollection(params: CreateUpdateCollection) {
    try {
      ...
      this.logger.error('An error occurred creating collection in Plex', err);
    }
  }
  ...
  public async updateCollection(body: CreateUpdateCollection) {
    try {
      ...
      this.logger.error('An error occurred updating collection in Plex', err);
    }
  }
  ...
  public async deleteCollection(
    ...
    try {
      ...
      this.logger.error('An error occurred deleting collection in Plex', err);
      return {
        status: 'NOK',
        code: 0,
  ...
  public async getCollectionChildren(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred getting collection children from Plex',
        err,
      );
    }
  }
  ...
  public async addChildToCollection(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred adding child to collection in Plex',
        e,
      );
  ...
  public async deleteChildFromCollection(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred deleting child from collection in Plex',
        e,
      );
  ...
  public async UpdateCollectionSettings(
    ...
    try {
      ...
      this.logger.error(
        'An error occurred updating collection settings in Plex',
        err,
      );
    }
  }
  ...
  public async getAvailableServers(): Promise<PlexDevice[]> {
    try {
      ...
      this.logger.error(
        'An error occurred getting available servers from Plex',
        e,
      );
      return [];
    }
  ...
  private async setMachineId() {
    try {
      ...
      this.logger.error(
        'An error occurred setting the machine ID for Plex',
        err,
      );
    }
  }
